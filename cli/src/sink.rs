...
pub enum SinkCmd {
    ...
    Datalog {
        ...
        #[clap(long, value_name = "REMOTE_URI", default_value = "ws://localhost:9944")]
        remote: String,
        /// Sender account seed URI.
        #[clap(short, value_name = "SECRET_URI")]
        suri: String,
        /// RWS subscription address.
        #[clap(long, value_name = "RWS_ADDRESS")]
        rws: Option<String>,
    },
    ...
    Launch {
        ...
        suri: String,
        /// Target CPS address.
        #[clap(short, value_name = "ROBOT_ADDRESS")]
        robot: String,
        /// RWS subscription address.
        #[clap(long, value_name = "RWS_ADDRESS")]
        rws: Option<String>,
    ...
    ReqRes {
        ...
        #[clap(value_name = "MULTIADDR", default_value = "/ip4/0.0.0.0/tcp/0")]
        address: String,
    },
}
